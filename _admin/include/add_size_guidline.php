    ...
    if ($pro_cat_id == 0) {
      ...
      if (!isset($file))
        ...
        if ($row = mysqli_fetch_assoc($MainCategory)) {
          ...
          $ldsQuery = "INSERT INTO sm_products (`pro_mcat_id`,`pro_cat_id`, `pro_ed_addtocart`, `pro_name`, `pro_price`, `pro_discount`, `pro_keyfeature`, `pro_overview`, `pro_image`, `pro_video`, `pro_ava_qty`,`pro_keywords`,`pro_sku`, `pro_status`)
          VALUES('$pro_mcat_id','$pro_cat_id','$pro_ed_addtocart', '$pro_name', '$pro_price','$pro_discount', '$pro_keyfeature', '$pro_overview', '$pro_name', '$pro_video', '$pro_ava_qty', '$pro_keywords', '$pro_sku','1')";
          ...
          if ($ldsQueryRun) {
            ...
            if (move_uploaded_file($file_tmp, '../imgs/products/resized/' . $pro_name)) {
              include "../imgs/products/resized/imageinc.php";
              create_thumbnail('../imgs/products/resized/' . $pro_name, '../imgs/products/' . $pro_name, 500, 500);
              unlink('../imgs/products/resized/' . $pro_name);
